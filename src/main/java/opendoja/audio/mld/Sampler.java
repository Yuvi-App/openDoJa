...
public interface Sampler
{
    ...
    /**
     * Create the synth-owned MLD playback module for the given sequence.
     *
     * The returned object receives parsed MLD events from {@link MLDPlayer} for
     * any behavior that is backend-specific, such as ext-B quirks, resource
     * audio, or synth-selected track-control policy.
     *
     * @param mld The active sequence.
     * @param sampleRate The player output sample rate.
     * @return The synth playback module for this sampler instance.
     */
    MLDPlaybackEngine createPlaybackEngine(MLD mld, float sampleRate);
